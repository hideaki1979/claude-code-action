...
## Fork Changes (hideaki1979/claude-code-action@beta)
...
- **Updated Base Action**: Uses `hideaki1979/claude-code-base-action@beta` which includes OAuth credential handling
